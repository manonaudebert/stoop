  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FAFAFA' }}>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '32px 20px' }}>
        ...
        {/* Category breakdown */}
        <div style={{ background: '#FFFFFF', border: '0.5px solid #E5E5E5', borderRadius: 12, padding: '20px 24px', marginBottom: 20 }}>
          <div className="skeleton" style={{ height: 12, width: 160, marginBottom: 16 }} />
          {[90, 70, 55, 40].map(w => (
            <div key={w} style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 12 }}>
              <div className="skeleton" style={{ height: 10, width: '30%' }} />
              <div className="skeleton" style={{ height: 8, width: `${w * 0.4}%`, borderRadius: 3 }} />
              <div className="skeleton" style={{ height: 10, width: 28, marginLeft: 'auto' }} />
            </div>
          ))}
        </div>
