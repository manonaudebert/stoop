...
export default function SfMapWrapper() {
  ...
  function handleSearchSelect(b: SfBuildingSummary) {
    ...
    setSelected({
      ...
      recent_complaints:     b.recent_complaint_count,
      heat_complaints:       b.heat_complaints,
  ...
  function handleMapSelect(raw: any) {
    ...
    setSelected({
      ...
      recent_complaints:     raw.recent_complaints ?? 0,
      heat_complaints:       raw.heat_complaints ?? 0,
