-- Add priority_ab_2yr to building_summary
-- Priority A+B complaints filed in the last 2 years; matches the primary sort
-- window (recent_complaint_count) so the tiebreaker is on the same time horizon.
