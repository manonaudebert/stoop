-- Add open_priority_a_complaints, open_priority_b_complaints, no_access_count
-- to building_summary so the DOB building page can power the 4 KPI cards.
--
-- nta_stats depends on building_summary, so it must be dropped and recreated too.
